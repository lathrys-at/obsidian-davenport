...
- A change to `docs/davenport-spec.md` or to `docs/davenport-test-plan.md` obeys two rules: every reference in the document resolves, and every sentence traces to a source. No rule holds the counts of these two documents flat. The file docs/dev/process.md states the rules.
