...
- All technical documentation, code comments, error messages, and instruction text follow Simplified Technical English (ASD-STE100). Apply the asd-ste100 skill as a mandatory authoring step; docs/dev/process.md states the procedure.
